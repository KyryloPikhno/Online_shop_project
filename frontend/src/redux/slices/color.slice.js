...
const getAll = createAsyncThunk("colorSlice/getAll", async (_, { rejectWithValue }) => {
  try {
...
const create = createAsyncThunk("colorSlice/create", async ({ color }, { rejectWithValue }) => {
  try {
...
const update = createAsyncThunk("colorSlice/update", async ({ color }, { rejectWithValue }) => {
  try {
