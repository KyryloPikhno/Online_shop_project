...
const getAll = createAsyncThunk("brandSlice/getAll", async (_, { rejectWithValue }) => {
  try {
...
const create = createAsyncThunk("brandSlice/create", async ({ brand }, { rejectWithValue }) => {
  try {
...
const update = createAsyncThunk("brandSlice/update", async ({ brand }, { rejectWithValue }) => {
  try {
